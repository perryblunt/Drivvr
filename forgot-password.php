...
$message .= "http://csc400.thecompletewebhosting.com/drivvr/resetpassword.php?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'jeromesmithr@gmail.com')){
