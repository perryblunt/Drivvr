...
while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
  ...
  //run query to get user get details
  ...
  if($_SESSION['user_id']){
    ...
    $phonenumber = "Please signup to see phone number";
  }
    //print trip
    echo
                 "<h4 class='row'>
                    ...
                    <div class='col-sm-8 journey'>
                        <div><span class='departure'>Departure:</span>
                            $tripDeparture.</div>

                        <div><span class='destination'>Destination:</span>
                            $tripDestination.</div>
                    ...
                    <div class='col-sm-2 price journey2'>
                        <div class='price'>$$tripPrice</div>
                        <div class='perseat'> Per Seat </div>
                        <div class='seatsavailable'>$seatsAvailable left
                        </div>
                </h4>
                <div class='moreinfo'>
                    <div>
                        ...
                        <div><span class='email'>&#9993:</span>$email</div>
                    </div>
